...
function main() {
  ...
  var canvas = document.querySelector("#canvas_BlockMan");
  ...
  // setup GLSL program
  var programInfo = webglUtils.createProgramInfo(gl, ["vertex-shader-3d-BlockMan", "fragment-shader-3d-BlockMan"]);
