...
function main() {
  ...
  var canvas = document.querySelector("#canvas_AttachDepthBufferToFrameBuffer");
  ...
  // setup GLSL program
  var program = webglUtils.createProgramFromScripts(gl, ["vertex-shader-3d", "fragment-shader-3d-AttachDepthBufferToFrameBuffer"]);
